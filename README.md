...
<div class="snippet-clipboard-content notranslate position-relative overflow-auto"><pre class="notranslate"><code>bun -v
</code></pre><div class="zeroclipboard-container">
    <clipboard-copy aria-label="Copy" class="ClipboardButton btn btn-invisible js-clipboard-copy m-2 p-0 d-flex flex-justify-center flex-items-center" data-copy-feedback="Copied!" data-tooltip-direction="w" value="bun -v" tabindex="0" role="button">
  ...
  <div class="snippet-clipboard-content notranslate position-relative overflow-auto"><pre class="notranslate"><code>snap install bun-js
    ...
    <clipboard-copy aria-label="Copy" class="ClipboardButton btn btn-invisible js-clipboard-copy m-2 p-0 d-flex flex-justify-center flex-items-center" data-copy-feedback="Copied!" data-tooltip-direction="w" value="snap install bun-js
...
isim belirleyelim cli seçelim ve create worker tıklayalım
![image](https://github.com/user-attachments/assets/4bc782f9-d02d-4583-b17e-421b260c5174)


açılan sayfadan sağ üstten launch worker tıklayıp gelen komutları terminalden screen açıp tek tek girelim. Login komutunda bizden mail ve şifre isteyecek onları atlamayalım.
